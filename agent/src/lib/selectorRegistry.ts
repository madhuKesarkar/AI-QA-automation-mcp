...
/** Loads the persisted selector registry. This is what lets the scenario
 * writer and runner stages reuse selectors across tickets instead of every
 * ticket needing fresh browser exploration — the single biggest cost
 * driver in the manual version of this process (see the SOP: we hit the
 * "don't guess locators" wall twice on the bulk-upload-rates work). */
